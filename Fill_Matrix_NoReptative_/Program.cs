...
namespace Fill_Matrix_NoReptative_
{
    ...
    internal partial class Program
    {
        ...
        static Rep_Matrix Rep_Matrixs = new Rep_Matrix();
        static Patterns_Alternative patterns_ = new Patterns_Alternative();
        ...
        From_First_Again:
            ...
            Generate_again:
                ...
                patterns_.Patterns_Alt.Remove(rep_Data_);
        ...
        public static dynamic Goal_Mark(byte[] Checksum)
        {
            int mark = 0;
            string temp_string = "";
            for (int i = 0; i < Checksum.Length; i++)
            {
                temp_string += Checksum[i].ToString();
            }
            mark += Math.Abs(int.Parse(temp_string.IndexOf("1").ToString()) - (int)Pattern_Number.One);
            mark += Math.Abs(int.Parse(temp_string.IndexOf("2").ToString()) - (int)Pattern_Number.Two);
            mark += Math.Abs(int.Parse(temp_string.IndexOf("3").ToString()) - (int)Pattern_Number.Three);
            mark += Math.Abs(int.Parse(temp_string.IndexOf("4").ToString()) - (int)Pattern_Number.Four);
            mark += Math.Abs(int.Parse(temp_string.IndexOf("5").ToString()) - (int)Pattern_Number.Five);
            mark += Math.Abs(int.Parse(temp_string.IndexOf("6").ToString()) - (int)Pattern_Number.Six);
            mark += Math.Abs(int.Parse(temp_string.IndexOf("7").ToString()) - (int)Pattern_Number.Seven);
            mark += Math.Abs(int.Parse(temp_string.IndexOf("8").ToString()) - (int)Pattern_Number.Eight);
            mark += Math.Abs(int.Parse(temp_string.IndexOf("0").ToString()) - (int)Pattern_Number.Zero);
